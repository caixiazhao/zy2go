...
class SkillUtil:
    skill_info = [
        ...
        SkillCfgInfo(102, 1, 4, 4, 0, 0, 0, 0, 0, 4, 0, 5, 0, 0, 3, 0, 0),
        SkillCfgInfo(102, 2, 3, 0, 0, 0, 0, 0, 0, 0, 0, 0, 7, 4, 0, 0, 0),
        SkillCfgInfo(102, 3, 2, 10, 5, 7, 0, 0, 0, 0, 0, 0, 0, 0, 6, 0, 0),
    ...
    def get_skill_info(hero_cfg_id, skill_id):
        for info in SkillUtil.skill_info:
            if info.hero_id == hero_cfg_id and info.skill_id == skill_id:
                return info
        return None
